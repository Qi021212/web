...
<script>
    $(function () {
        $.post("/api/cart/CartAmountServlet", {goodsid:11}, function(data){
            if(data == "login"){
                $(".card_num").text(0)
            }else{
                $(".card_num").text(data)
    ...
    <div class="container">
        ...
        <div class="header-info">
            ...
            <div class="header-right cart">
                <a href="/cart/CartListServlet">
                    <span class="glyphicon glyphicon-shopping-cart <c:if test="${param.flag==8 }">active</c:if>" aria-hidden="true"><span class="card_num"></span></span>
                </a>
            </div>
